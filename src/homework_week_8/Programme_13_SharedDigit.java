...
/**
 * Write a method named hasShareDigit with two parameters of type int
 * Each number should be within the range of 10(inclusive) -99(inclusive).If one of th numbers is not
